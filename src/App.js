...
function genSchemaScript(site) {
  ...
  return `<!-- Schema Markup Manager | ${site.name} | ${site.plan === "pro" ? "PRO" : "BASIC"} | v16 -->
<script>
(function(){
